var GuitarChordsDb = (function () {
    ...
    ***/
    ...
    customElements.define("guitar-chords-db", GuitarChord);
    ...
    /* src/GuitarChords.svelte generated by Svelte v3.46.6 */
    ...
    // (45:8) {#each NOTES as base_note}
    function create_each_block_1(ctx) {
    	let div;
    	let t0_value = /*base_note*/ ctx[14] + "";
    	let t0;
    	let t1;
    	let mounted;
    	let dispose;
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[8](/*base_note*/ ctx[14]);
    	}
    	...
    	return {
    		c() {
    			...
    			toggle_class(div, "button-selected", /*base_note*/ ctx[14] === /*note*/ ctx[0].substring(0, 1).toUpperCase());
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, t0);
    ...
    // (53:4) {#if getChordName(note_chords[0]) !== ''}
    function create_if_block(ctx) {
    	...
    	guitarchord = new GuitarChord({
    			props: {
    				fingering: /*fingering*/ ctx[3],
    				strings: /*strings*/ ctx[4]
    			}
    		});
    	...
    	return {
    		c() {
    			...
    			t = space();
    			div1 = element("div");
    			create_component(guitarchord.$$.fragment);
    			attr(div0, "class", "chords-row");
    			attr(div1, "class", "chord");
    		},
    		m(target, anchor) {
    			...
    			mount_component(guitarchord, div1, null);
    			current = true;
    		},
    		p(ctx, dirty) {
    			if (dirty & /*getChordName, note_chords, chord, setChord*/ 134) {
    				each_value = /*note_chords*/ ctx[2];
    				let i;
    			...
    			const guitarchord_changes = {};
    			if (dirty & /*fingering*/ 8) guitarchord_changes.fingering = /*fingering*/ ctx[3];
    			if (dirty & /*strings*/ 16) guitarchord_changes.strings = /*strings*/ ctx[4];
    			guitarchord.$set(guitarchord_changes);
    		},
    		i(local) {
    			if (current) return;
    			transition_in(guitarchord.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(guitarchord.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			...
    			destroy_component(guitarchord);
    		}
    	};
    }

    // (55:12) {#each note_chords as note_chord}
    function create_each_block(ctx) {
    	let div;
    	let t0_value = getChordName(/*note_chord*/ ctx[11]) + "";
    	let t0;
    	let t1;
    	let mounted;
    	let dispose;
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[9](/*note_chord*/ ctx[11]);
    	}
    	...
    	return {
    		c() {
    			...
    			toggle_class(div, "button-selected", getChordName(/*note_chord*/ ctx[11]) === getChordName(/*chord*/ ctx[1]));
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, t0);
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*note_chords*/ 4 && t0_value !== (t0_value = getChordName(/*note_chord*/ ctx[11]) + "")) set_data(t0, t0_value);

    			if (dirty & /*getChordName, note_chords, chord*/ 6) {
    				toggle_class(div, "button-selected", getChordName(/*note_chord*/ ctx[11]) === getChordName(/*chord*/ ctx[1]));
    			}
    		},
    		d(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let div0;
    	let t;
    	let show_if = getChordName(/*note_chords*/ ctx[2][0]) !== '';
    	let current;
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*NOTES, note, setBaseNote*/ 97) {
    			...
    			if (dirty & /*note_chords*/ 4) show_if = getChordName(/*note_chords*/ ctx[2][0]) !== '';

    			if (show_if) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*note_chords*/ 4) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*note*/ 1) {
    			 $$invalidate(2, note_chords = initChords(note));
    		}

    		if ($$self.$$.dirty & /*chord*/ 2) {
    			 $$invalidate(3, fingering = setFingering(chord));
    		}

    		if ($$self.$$.dirty & /*chord*/ 2) {
    			 $$invalidate(4, strings = setStrings(chord));
    		}
    	};
    ...
    class GuitarChordsDb extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.notes-menu{display:flex;align-items:center;flex-direction:column;width:100%;height:100%}.notes-row{display:flex;flex-wrap:wrap;border:none;width:fit-content;gap:0.5rem;margin-bottom:1rem}.chords-row{display:grid;grid-template-columns:auto auto auto auto auto;border:none;width:fit-content;gap:0.5rem}.chord{width:200px;display:flex;align-items:center}.note-button{border:1px solid #999;border-radius:5px;color:#999;width:fit-content;font-family:Verdana, Arial, Helvetica, sans-serif;font-weight:bolder;font-size:large;cursor:pointer;padding:0 0.5rem}.chord-button{border:1px solid #999;border-radius:5px;color:#999;width:available;text-align:center;font-family:Verdana, Arial, Helvetica, sans-serif;font-weight:normal;font-size:small;cursor:pointer;padding:0.2em 0.3rem}.button-selected{border:1px solid #1A1A1A;color:#1A1A1A;background-color:#999}</style>`;
    ...
    customElements.define("guitar-chords-db", GuitarChordsDb);

    return GuitarChordsDb;
